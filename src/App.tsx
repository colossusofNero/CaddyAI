    ...
    <div className="w-full max-w-5xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        <header className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-semibold">CaddyAI v2 — Shot Planner</h1>
        </header>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-white/70 rounded-2xl shadow">
            ...
            <select value={q.lie} onChange={(e) => setQ({ ...q, lie: e.target.value as Lie })} className="mt-2 w-full rounded-xl border p-2">
