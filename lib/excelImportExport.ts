...
export function downloadExcelTemplate(clubs: Club[], shots: Shot[]): void {
  ...
  const instructions = [
    ...
    ['- Shot Name: Standard, Knockdown, Punch, Chip, Pitch, Flop, Bump-and-Run, etc.'],
    ['- Takeback: Full, 3/4, 1/2, 1/4, Chip, or Flop'],
    ['- Face: Square, Draw, Fade, Hood, Open, or Flat'],
